...
namespace winrt::Microsoft::Terminal::Settings::Model::implementation
{
    ...
    Collections::IMapView<winrt::hstring, Microsoft::Terminal::Settings::Model::Command> Command::NestedCommands()
    {
                                              ...
                                              std::vector<SettingsLoadWarnings>& warnings)
    {
        ...
        if (const auto nestedCommandsJson{ json[JsonKey(CommandsKey)] })
        {
            ...
            result->_subcommands = winrt::single_threaded_map<winrt::hstring, winrt::Microsoft::Terminal::Settings::Model::Command>();
    ...
    std::vector<SettingsLoadWarnings> Command::LayerJson(Windows::Foundation::Collections::IMap<winrt::hstring, winrt::Microsoft::Terminal::Settings::Model::Command>& commands,
    ...
    // Return Value:
    // - <none>
    void Command::ExpandCommands(Windows::Foundation::Collections::IMap<winrt::hstring, winrt::Microsoft::Terminal::Settings::Model::Command>& commands,
                                 Windows::Foundation::Collections::IVectorView<winrt::Microsoft::Terminal::Settings::Model::Profile> profiles,
                                 gsl::span<winrt::Microsoft::Terminal::Settings::Model::ColorScheme> schemes,
                                 std::vector<SettingsLoadWarnings>& warnings)
    {
    ...
    std::vector<winrt::Microsoft::Terminal::Settings::Model::Command> Command::_expandCommand(Command* const expandable,
                                                                     Windows::Foundation::Collections::IVectorView<winrt::Microsoft::Terminal::Settings::Model::Profile> profiles,
                                                                     gsl::span<winrt::Microsoft::Terminal::Settings::Model::ColorScheme> schemes,
                                                                     std::vector<SettingsLoadWarnings>& warnings)
    {
